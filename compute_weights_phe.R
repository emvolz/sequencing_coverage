...
## TO USE
## Rscript compute_weights_phe.R --outroot b0- --postcode postcode_to_la.csv --days 14
##
...
#~ ext <- list.files(path)
# alignment: 
phedf = read.csv( path_to_phe_data, stringsAs=FALSE)
...
phedf$date <- ymd( phedf$earliest_specimen_date ) #sampledate  )
